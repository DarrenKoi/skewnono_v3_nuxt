...
from backend.chat.answer import contract, data
...
def test_history_is_capped_before_the_provider_sees_it(monkeypatch):
    ...
    from backend.chat.answer.providers import mock as mock_provider
...
def test_a_usable_checkout_selects_the_rag_provider(monkeypatch):
    ...
    from backend.chat.answer.providers import rag as rag_provider
