...
backend.chat.answer.contract``. These tests are what keeps the thing
they run honest.
"""
...
from backend.chat.answer import contract
from backend.chat.answer.contract import ContractViolation, validate_answer
