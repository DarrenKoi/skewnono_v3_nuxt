...
from backend.msr_file.contracts import MsrArtifactError
from backend.msr_file.data import get_msr_artifact, get_msr_file
...
def msr_files_bulk():
    ...
    per-user rate limit (50/5s in backend/__init__.py) and leaves the panel
