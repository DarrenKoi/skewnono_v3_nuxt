...
backend/_auth/middleware.py::_deny_if_blocked: a grant added via
...
from backend.access_control.providers.mock import (
...
def _provider():
    if get_data_provider("access_control") == "office":
        from backend.access_control.providers import office
        return office
    from backend.access_control.providers import mock
    return mock
