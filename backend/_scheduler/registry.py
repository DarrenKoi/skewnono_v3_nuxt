...
from backend._scheduler.tasks.log_retention import purge_old_logs
from backend._scheduler.tasks.uwsgi_reload import touch_reload
...
def _image_cache_purge_cron() -> dict:
    ...
    """
    from backend.msr_image.config import load_config as load_image_config
