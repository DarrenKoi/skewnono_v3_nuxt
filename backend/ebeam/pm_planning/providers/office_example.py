...
from backend.ebeam._office_bm_pm import latest_pm_by_tool, maintenance_events
...
from backend.ebeam.pm_planning.contracts import (
    BeamCondition,
    CellSkew,
    ConsensusCell,
    EpochPoint,
...
if __name__ == "__main__":  # pragma: no cover
    ...
    #   .venv/bin/python -m backend.ebeam.pm_planning.providers.office R3
    #
    ...
    from backend.ebeam._office_msr_cd import AXIS_ENV_VAR, MONITOR_RECIPE_ENV_VAR
