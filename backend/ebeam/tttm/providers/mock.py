...
from backend.ebeam._analysis_window import window_days
from backend.ebeam.tttm.contracts import ParameterProfile
from backend.ebeam.tttm.profile import build_parameter_profile, empty_parameter_profile
...
def _measured_parameters(tool_slug: str, fab_name: str, recipe_id: str) -> tuple[str, ...]:
    ...
    """
    from backend.msr_file.providers.mock import program_parameters
