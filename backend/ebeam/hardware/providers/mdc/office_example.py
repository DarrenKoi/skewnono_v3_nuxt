...
``docs/datatables/hitachi/hardware_mdc_setting.txt`` plus the sibling ``sce`` adapter,
...
At the office: fill in REDIS_* in ``backend/.env`` and
...
if __name__ == "__main__":  # pragma: no cover
    ...
    #   python -m backend.ebeam.hardware.providers.mdc.office
    ...
    try:
        ...
        _fail("Redis", exc, "Check REDIS_HOST/REDIS_PORT/REDIS_PASSWORD in "
                            "backend/.env. Expected at home: unreachable.")
