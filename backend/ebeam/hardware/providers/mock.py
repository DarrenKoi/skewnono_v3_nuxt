...
from backend.ebeam.hardware.contracts import HardwarePayload, ServiceKey
...
from backend.ebeam.hardware.providers.reso_center.mock import (
    build_reso_center_docs,
)
from backend.ebeam.hardware.providers.sce.mock import (
    build_sce_history,
    build_sce_settings,
)
from backend.ebeam.hardware.providers.sharpness.mock import (
