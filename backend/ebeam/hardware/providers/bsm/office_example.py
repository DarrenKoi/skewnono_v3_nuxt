...
straight off each doc (see ``frontend/app/utils/beamMetrics.ts``), so the
...
from backend.ebeam.hardware.metrics import (
    PROFILE16_KEYS,
    SCALAR_KEYS,
)
...
# Fixed selectors for the faithful "total" docs (per docs/datatables/hitachi/hardware_beam_shape.txt).
DOC_TYPE = "total"
...
if __name__ == "__main__":
    ...
    #   .venv/bin/python -m backend.ebeam.hardware.providers.bsm.office_example ECXDX1234 R3
    #
