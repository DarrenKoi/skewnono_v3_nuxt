...
from backend.ebeam.hardware.contracts import HardwarePayload
from backend.ebeam.hardware.providers import office_example as dispatcher
from backend.ebeam.hardware.providers.sharpness import (
    mock,
...
# A raw `_source` doc mirroring docs/datatables/hitachi/hardware_sharpness_monitor_cdsem.txt:
