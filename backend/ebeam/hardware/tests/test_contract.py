...
Home:   .venv/bin/pytest backend/ebeam/hardware
Office: SKEWNONO_HARDWARE_PROVIDER=office .venv/bin/pytest backend/ebeam/hardware
"""
...
from backend._logging.providers import logger as provider_logger
from backend.ebeam.hardware import data
from backend.ebeam.hardware.contracts import (
    VALID_SERVICES,
    HardwarePayload,
)
from backend.ebeam.hardware.providers import office_example
