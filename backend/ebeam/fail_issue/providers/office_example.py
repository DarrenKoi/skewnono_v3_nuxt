...
``backend/ebeam/_office_meas_hist.py`` (see its docstring for
...
At the office: fill in OPENSEARCH_* / REDIS_* in ``backend/.env``,
...
from backend.ebeam.fail_issue.contracts import (
    AlignRankingRow,
    DailyTrendPoint,
    DeviceRow,
...
from backend.ebeam.fail_issue.providers._shape import (
    EquipmentGridRow,
    RecipeGridRow,
    TrendGridRow,
...
from backend.ebeam.fail_issue.providers.mock import (
    MEAS_FAIL_THRESHOLD,
)
from backend.ebeam.recipe_tat.contracts import ToolType
...
if __name__ == "__main__":
    ...
    #     .venv/bin/python -m backend.ebeam.fail_issue.providers.office
