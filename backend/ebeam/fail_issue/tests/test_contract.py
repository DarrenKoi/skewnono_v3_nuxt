...
Home:   .venv/bin/pytest backend/ebeam/fail_issue
Office: SKEWNONO_FAIL_ISSUE_PROVIDER=office .venv/bin/pytest backend/ebeam/fail_issue
...
def _compare_over_http(query: str) -> dict:
    ...
    from backend.ebeam.fail_issue.routes import bp
...
def test_over_the_cap_is_truncated_and_the_echo_says_so():
    ...
    from backend.ebeam._analytics_routes import MAX_COMPARE_EQPS
