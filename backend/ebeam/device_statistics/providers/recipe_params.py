...
소비:  frontend/app/utils/ruleEngine.ts (evaluateLot) · outlierDetect.ts (detectDeviceOutliers)
...
if __name__ == "__main__":
    # 미리보기:  python -m backend.ebeam.device_statistics.providers.recipe_params
    import pprint
