...
from backend.ebeam._tool_specs import ToolType, model_to_tool_type
from backend.ebeam.lateral_recipe.contracts import (
...
if __name__ == "__main__":
    ...
    #   .venv/bin/python -m backend.ebeam.lateral_recipe.providers.office
    import sys
