...
Home:   .venv/bin/pytest backend/ebeam/lateral_recipe
Office: SKEWNONO_LATERAL_RECIPE_PROVIDER=office .venv/bin/pytest backend/ebeam/lateral_recipe
...
from backend.ebeam.lateral_recipe import data
from backend.ebeam.lateral_recipe.contracts import LateralRecipeResponse
