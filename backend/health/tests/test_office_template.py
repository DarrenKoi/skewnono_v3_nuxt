...
from backend.health.providers import office_example as office
from backend.health.providers import probe_common as probe
...
def no_env_loading(monkeypatch):
    """The probes self-load backend/.env; tests must not depend on
