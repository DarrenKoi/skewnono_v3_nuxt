...
the shared anchor come from ``backend/ebeam/_office_meas_hist.py``
...
from backend.meas_hist.providers._shared import normalize_fail_ratio
...
if __name__ == "__main__":
    ...
    #     .venv/bin/python -m backend.meas_hist.providers.office
