...
from backend._logging.providers import install_provider_logging, logger
from backend._runtime.data_provider import get_mode, resolve_all
from backend._runtime.office_template import stale_adapters
...
def _log_chat_answer_source() -> None:
    ...
    """
    from backend.chat.rag import rag_ready, rag_root
