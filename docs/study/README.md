# Frontend 학습 노트 (frontend)

백엔드 개발자 최대영이 `frontend`(Nuxt 4 + NuxtUI + TypeScript) 코드베이스를 공부하기 위한 정리본입니다.

## 학습 개요

`frontend`은 **SKEWNONO** 프로젝트의 Nuxt SPA로, 다음 스택으로 구성되어 있습니다.
