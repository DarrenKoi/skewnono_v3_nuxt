...
<template>
  <div>
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-8">
      ...
      <UCard class="dashboard-surface rounded-2xl">
        <div class="text-center">
          <div class="text-3xl font-bold text-zinc-800 dark:text-zinc-200">248</div>
          <div class="text-sm text-gray-500">Online</div>
        </div>
      </UCard>
      <UCard class="dashboard-surface rounded-2xl">
        <div class="text-center">
          <div class="text-3xl font-bold text-zinc-700 dark:text-zinc-300">42</div>
          <div class="text-sm text-gray-500">Active Jobs</div>
        </div>
      </UCard>
      <UCard class="dashboard-surface rounded-2xl">
        <div class="text-center">
          <div class="text-3xl font-bold text-zinc-600 dark:text-zinc-400">3</div>
