...
const fabStats = computed(() => {
  return fabs.filter(f => f.id !== 'all').map(fab => ({
    ...fab,
    toolCount: Math.floor(Math.random() * 12) + 4,
...
<template>
  <div>
    <div class="mb-6">
      <h1 class="text-2xl font-bold">HV-SEM Overview</h1>
      <p class="text-gray-600 dark:text-gray-400">All fabs - 48 tools</p>
    </div>
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-8">
      <UCard>
        <div class="text-center">
          <div class="text-3xl font-bold text-primary-600">48</div>
