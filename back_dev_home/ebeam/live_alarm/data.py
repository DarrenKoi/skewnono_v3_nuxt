...
from back_dev_home.ebeam.live_alarm.contracts import LiveAlarmPayload
from back_dev_home.ebeam.live_alarm.providers import mock as mock_provider
...
def _provider():
    if get_data_provider("live_alarm") == "office":
        from back_dev_home.ebeam.live_alarm.providers import office
        return office
