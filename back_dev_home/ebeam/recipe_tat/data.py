...
from back_dev_home.ebeam.recipe_tat.providers import mock as mock_provider
from back_dev_home.ebeam.recipe_tat.providers.mock import ANCHOR_TIME
...
def _provider():
    if get_data_provider("recipe_tat") == "office":
        from back_dev_home.ebeam.recipe_tat.providers import office
        return office
