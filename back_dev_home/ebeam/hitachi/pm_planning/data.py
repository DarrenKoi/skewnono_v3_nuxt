"""SWAP SURFACE for the pm-planning fleet snapshot.

This mock synthesizes a fab-scoped CD-SEM fleet snapshot: per-tool Up-gate
inputs and per-cell signed skew. The future office implementation should keep
the same public function and TypedDict shape while replacing this generator
