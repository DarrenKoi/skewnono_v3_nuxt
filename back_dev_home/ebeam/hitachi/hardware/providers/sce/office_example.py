...
- ``build_sce_settings`` — the LATEST collection from the Redis hash
  ...
  dict (see ``docs/datatables/sce_setting.txt``). The whole fab map IS the
...
if __name__ == "__main__":
    ...
    #   .venv/bin/python -m back_dev_home.ebeam.hitachi.hardware.providers.sce.office <eqp_id> <fab_name>
    import sys
