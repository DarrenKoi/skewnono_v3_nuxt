...
from back_dev_home.ebeam._tool_specs import ToolSlug
...
def get_storage(
    ...
    if get_data_provider("storage") == "office":
        from back_dev_home.ebeam.storage.providers.office import (
            get_storage as load_storage,
        )
    else:
        from back_dev_home.ebeam.storage.providers.mock import (
            get_storage as load_storage,
        )
