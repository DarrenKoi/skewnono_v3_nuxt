...
Produces the raw doc shape documented in `docs/datatables/hitachi/hardware_beam_shape.txt`:
...
from back_dev_home.ebeam.hardware.metrics import BEAM_SHAPE_METRICS
